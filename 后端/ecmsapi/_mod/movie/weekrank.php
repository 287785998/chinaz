...
$sort = $api->param('sort' , 'onclick desc'); // 点击排序
...
//一周
    $map .= ' and newstime>UNIX_TIMESTAMP()-86400*30';
...
// 获取当前页的数据
$list = $total > 0 || $page > $totalpage ? $api->load('db')->select('[!db.pre!]ecms_movie' , '*' , $map , $pagesize.','.$page , $sort) : [];
