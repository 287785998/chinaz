...
$datatime = $api->param('datatime' , 'UNIX_TIMESTAMP()-86400*0'); // 头条
...
// 获取当前页的数据
$list = $total > 0 || $page > $totalpage ? $api->load('db')->select('[!db.pre!]ecms_movie' , '*' , $map , $pagesize.','.$page , 'onclick desc') : [];
